...
|--- | --- |
| 1. [Block World Dataset (Bisk et al. 2016)](http://yonatanbisk.com/papers/2016-NAACL.pdf): An 2D domain with full observability. Instructions ask the agent to manipulate blocks on a map. | 2. [LANI (Misra et al. 2018)](http://cs.cornell.edu/~dkm/papers/mbbnsa-emnlp.2018.pdf): A partially observed 3D domain for navigating in an open landscape based on instructions. |

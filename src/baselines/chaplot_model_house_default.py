...
class a3c_lstm_ga_default(torch.nn.Module):
    ...
    def __init__(self, args, action_space, config=None):
        ...
        self.actor_linear = nn.Linear(256 + self.time_emb_dim, num_actions)
    ...
    def print_weight(self):
        print("Weight is ", self.attn_linear.weight[:3, :3].contiguous().view(-1)[:6].cpu().data.numpy())
    ...
    def forward(self, inputs, cached_computation=None):
        ...
        # print("image rep size: ", x_image_rep.size(), " , attention size: ", x_attention.size())

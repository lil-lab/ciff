...
class a3c_lstm_ga_prev_stategating(torch.nn.Module):

    def __init__(self, args, config=None):
        super(a3c_lstm_ga_prev_stategating, self).__init__()
        self.config = config
        ...
        self.attn_linear = nn.Linear(self.gru_hidden_size + 256, 64)
    ...
    def forward(self, inputs, cached_computation=None):
        ...
        x_attention_input = torch.cat([x_instr_rep, hx], dim=1)

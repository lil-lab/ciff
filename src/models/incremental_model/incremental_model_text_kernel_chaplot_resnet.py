...
from models.incremental_module.incremental_multimodal_attention_chaplot_module import \
    IncrementalMultimodalAttentionChaplotModule
...
from models.incremental_module.incremental_multimodal_text_kernel_chaplot_module import \
    IncrementalMultimodalTextKernelChaplotModule
...
class IncrementalModelTextKernelChaplotResNet(AbstractIncrementalModel):
    def __init__(self, config, constants):
        AbstractIncrementalModel.__init__(self, config, constants)
        self.none_action = config["num_actions"]
        self.image_module = ImageChaplotResnetModule(
        ...
        self.final_module = IncrementalMultimodalTextKernelChaplotModule(
            image_module=self.image_module,
            image_recurrence_module=self.image_recurrence_module,
            text_module=self.text_module,
            max_episode_length=100,  # (constants["horizon"] + constants["max_extra_horizon"]),
            final_image_height=8, final_image_width=8)

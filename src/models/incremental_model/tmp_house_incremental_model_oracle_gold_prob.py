...
from models.incremental_module.oracle_attention_prob import OracleGold, \
    OracleGoldWithImage
...
class TmpHouseIncrementalModelOracleGoldProb(AbstractIncrementalModel):
    ...
    def get_probs(self, agent_observed_state, model_state, mode=None, volatile=False):
        ...
        probs_batch, new_model_state, image_emb_seq, state_feature = self.final_module(
            image_batch, instructions_batch, time, mode, model_state, instruction_string, agent_observed_state.goal)
    ...
    def get_attention_prob(self, agent_observed_state, model_state, mode=None, volatile=False):
        ...
        state_feature = self.final_module.get_attention_prob(image_batch, instructions_batch,
...
class IncrementalModelOracleGoldProbWithImage(TmpHouseIncrementalModelOracleGoldProb):

    def __init__(self, config, constants):
        TmpHouseIncrementalModelOracleGoldProb.__init__(self, config, constants, use_image=True)

...
from models.module.text_implicit_factorization_module import TextImplicitFactorizationModule
...
class IncrementalModelRecurrentImplicitFactorizationResnet(AbstractIncrementalModel):

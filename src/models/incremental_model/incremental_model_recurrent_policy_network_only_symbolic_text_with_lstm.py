...
from models.incremental_module.incremental_multimodal_mixed_text_recurrent_simple_module import \
    IncrementalMultimodalMixedTextRecurrentSimpleModule
...
class IncrementalModelRecurrentPolicyNetworkSymbolicTextWithLSTMResnet(AbstractIncrementalModel):
    ...
    def load_saved_model(self, load_dir):
        ...
        symbolic_text_module_path = os.path.join(load_dir, "symbolic_text_module_state.bin")
        self.symbolic_text_module.load_state_dict(torch_load(symbolic_text_module_path))
        lstm_text_module_path = os.path.join(load_dir, "lstm_text_module_state.bin")
        self.lstm_text_module.load_state_dict(torch_load(lstm_text_module_path))
    ...
    def save_model(self, save_dir):
        ...
        symbolic_text_module_path = os.path.join(save_dir, "symbolic_text_module_state.bin")
        torch.save(self.symbolic_text_module.state_dict(), symbolic_text_module_path)
        lstm_text_module_path = os.path.join(save_dir, "lstm_text_module_state.bin")

...
class TmpStreetviewIncrementalModelConcatRecurrentPolicyNetwork(AbstractIncrementalModel):
    ...
    def __init__(self, config, constants):
        ...
        #     input_num_channels=128,  # TODO this value keeps changing.
        #     image_height=config["image_height"],
        #     image_width=config["image_width"],
        #     using_recurrence=True)
        self.image_module = StreetviewImageModule(
            image_emb_size=constants["image_emb_dim"],
            input_num_channels=2048,  # TODO this value keeps changing.
            image_height=config["image_height"],
            image_width=config["image_width"],
            using_recurrence=True)
        num_channels, image_height, image_width = 256, 1, 8
        self.num_cameras = 1
        ...
        self.final_module = IncrementalMultimodalConcatModule(
            image_module=self.image_module,
            image_recurrence_module=self.image_recurrence_module,
            text_emb_size=256,
            text_module=self.text_module,
            max_episode_length=150,
            final_num_channels=num_channels, final_image_height=image_height, final_image_width=image_width)

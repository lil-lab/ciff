...
class IncrementalModelOracleGoldProb(AbstractIncrementalModel):
...
class IncrementalModelOracleGoldProbWithImage(IncrementalModelOracleGoldProb):
    def __init__(self, config, constants):
        IncrementalModelOracleGoldProb.__init__(self, config, constants,
                                                use_image=True)

...
from models.module.multimodal_text_kernel_recurrent_simple_with_stop_module \
    import MultimodalTextKernelRecurrentSimpleWithStopModule
...
class ModelTextKernelRecurrentPolicyNetworkResnetWithStop(AbstractModel):
    def __init__(self, config, constants):
        ...
        if config["use_pointer_model"]:
            ...
            total_emb_size = (constants["image_emb_dim"]
                              ...
                              + constants["action_emb_dim"])
        final_module = MultimodalTextKernelRecurrentSimpleWithStopModule(

...
import numpy as np
import torch
from models.module.multimodal_simple_position_module import MultimodalSimplePositionModule
...
from models.module.image_position_resnet_module import ImagePositionResnetModule
from utils.cuda import cuda_var


class ModelPositionPredictionNetworkResnet(AbstractModel):
    ...
    def get_position_batch(self, agent_observed_state_list):

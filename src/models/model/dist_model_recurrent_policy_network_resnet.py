...
from models.module.dist_multimodal_recurrent_simple_module import DistMultimodalRecurrentSimpleModule
from utils.cuda import cuda_var, cuda_tensor


class DistModelRecurrentPolicyNetworkResnet(object):
    def __init__(self, config, constants):
        ...
        final_module = DistMultimodalRecurrentSimpleModule(
    ...
    def get_dist(self, agent_observed_state_list, mode=None):
        ...
        scalar_batch = self.final_module(image_batch, image_seq_lens_batch,

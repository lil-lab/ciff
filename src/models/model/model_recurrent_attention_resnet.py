...
from models.module.image_attention_resnet_module import ImageAttentionResnetModule
from models.module.multimodal_recurrent_attention_module import \
    MultimodalRecurrentAttentionModule
...
from models.module.recurrence_simple_module import RecurrenceSimpleModule
from utils.cuda import cuda_var, cuda_tensor


class ModelRecurrentAttentionResnet(AbstractModel):
    def __init__(self, config, constants):
        AbstractModel.__init__(self, config, constants)
        self.none_action = config["num_actions"]
        self.image_module = ImageAttentionResnetModule(
        ...
        final_module = MultimodalRecurrentAttentionModule(

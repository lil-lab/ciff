...
from models.module.multimodal_text_kernel_recurrent_simple_module import MultimodalTextKernelRecurrentSimpleModule
...
class ModelTextKernelRecurrentPolicyNetworkResnet(AbstractModel):

...
from models.module.multimodal_recurrent_simple_module import \
    MultimodalRecurrentSimpleModule
from models.module.text_selfattention_module import TextSelfAttentionModule
...
class ModelRecurrentSelfAttentionResnet(AbstractModel):
    def __init__(self, config, constants):
        ...
        self.text_module = TextSelfAttentionModule(
        ...
        total_emb_size = (constants["image_emb_dim"]
                          + constants["lstm_emb_dim"] * 2 * num_heads

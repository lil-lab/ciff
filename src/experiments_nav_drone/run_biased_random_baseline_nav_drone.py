...
from baselines.biased_random_baseline import BiasedRandomBaseline
...
experiment = "./results/segments_biased_random_baseline"
...
try:
    ...
    baseline = BiasedRandomBaseline(server=server,
                                    action_space=action_space,
                                    meta_data_util=meta_data_util,
                                    config=config,
                                    constants=constants)
    baseline.test_baseline(test_dataset)

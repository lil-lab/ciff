...
from baselines.mfa_baseline import MFABaseline
...
experiment = "./results/segments_forward_baseline_6000_test"
...
try:
    ...
    logging.info("FORWARD BASELINE")
    forward_baseline = MFABaseline(server=server,
                                   action_space=action_space,
                                   meta_data_util=meta_data_util,
                                   config=config,
                                   constants=constants,
                                   action_name="Forward")
    forward_baseline.test_baseline(test_dataset)

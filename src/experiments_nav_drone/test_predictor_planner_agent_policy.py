...
experiment = "./results/emnlp-camera-ready-end-to-end-training"
...
try:
    ...
    # predictor_model.load_saved_model("./results/emnlp-camera_ready_train_two_stage_model/predictor_contextual_bandit_0_epoch_6")
    # predictor_model.load_saved_model(
    #     "./results/emnlp-rebuttal-unet-goal-prediction-dummy-instruction/goal_prediction_single_supervised_epoch_1")
    # predictor_model.load_saved_model(
    #     "./results/goal_prediction_m4jksum1-deadline-emnlp/goal_prediction_single_supervised_epoch_12")

    planner_model = IncrementalModelOracleGoldProb(config, constants, use_image=False)
    # planner_model.load_saved_model("./results/oracle_gold_prob_cb_6000_withimage/contextual_bandit_5_epoch_12")
    planner_model.load_saved_model("./results/oracle_gold_prob_cb_6000/contextual_bandit_5_epoch_17")
    # planner_model.load_saved_model("./results/emnlp-camera_ready_train_two_stage_model/navigator_contextual_bandit_0_epoch_6")
    # planner_model.load_saved_model("./results/emnlp-rebuttal-oracle_gold_prob_cb_6000-no-LSTM-no-Image/contextual_bandit_5_epoch_5")

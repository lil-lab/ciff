...
from learning.single_client.supervised_learning_detect_landmarks import SupervisedLearningDetectLandmarks
...
from models.resnet_landmark_detection import ResnetLandmarkDetection
from setup_agreement_nav_drone.validate_setup_nav_drone import \
    NavDroneSetupValidator
from utils.tensorboard import Tensorboard

experiment_name = "supervised_landmark_detection"
...
try:
    ...
    model = ResnetLandmarkDetection(config, constants, None)
    ...
    # Read the dataset
    train_split = SupervisedLearningDetectLandmarks.parse("../logs/start_images/train_images")
    tune_split = SupervisedLearningDetectLandmarks.parse("../logs/start_images/tune_images")
    ...
    learning_alg = SupervisedLearningDetectLandmarks(model=model,

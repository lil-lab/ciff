...
from learning.asynchronous.asynchronous_two_stage_contextual_bandit_learning import AsynchronousTwoStageContextualBandit
...
def main():
    ...
    experiment_name = "emnlp-camera_ready_train_two_stage_model-repeat"
    ...
    try:
        ...
        for i, port in enumerate(ports):
            ...
            p = mp.Process(target=AsynchronousTwoStageContextualBandit.do_train, args=(shared_navigator_model,

...
from models.incremental_model.incremental_model_emnlp_single_action_space import IncrementalModelEmnlpSingleActionSpace
...
def main():
    ...
    experiment_name = "emnlp_on_drone_full_attempt_2_fixed_crossentropy" #oracle_gold_prob_cb"
    ...
    with open("data/nav_drone/config_localmoves_6000_emnlp.json") as f:
        config = json.load(f)
    ...
    try:
        ...
        model_type = IncrementalModelEmnlpSingleActionSpace
        ...
        #train_split = all_train_data[0:10]
        #tune_split = all_train_data[5:10]
